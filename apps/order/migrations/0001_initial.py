    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey( on_delete=django.db.models.deletion.CASCADE, to='apps.products.product' )),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_to', models.DateTimeField(default=datetime.datetime(2020, 12, 21, 23, 53, 37, 953818))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ForeignKey( on_delete=django.db.models.deletion.CASCADE, to='apps.order.coupon' )),
                ('order_items', models.ManyToManyField( to='apps.order.Cart' )),
